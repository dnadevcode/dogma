function [oS] = calc_overlap_pcc_sort(barcodeGen, sF,minOverlap)
...
psfPar = 0.06; % depends on psf. so possibly adjust for the re-scale factor too
...
%                 toc
            ...
            overlapStruct{i,j}.sc = xcorrs(b(d),d);
