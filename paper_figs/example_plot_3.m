...
% end
title('(B) Graph of bargroup islands ','Interpreter','latex','FontSize',8)

nexttile([2 1])

hold on

title('(C) Bargroup island (1)','Interpreter','latex','FontSize',8)
...
f = figure('OuterPosition',  [300 300 500 200])
...
title('Consensus barcode for synthetic experiment','Interpreter','latex')
...
colormap("gray")
% 
print('FIGS/Fig4S.eps','-depsc','-r300');
