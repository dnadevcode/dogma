...
minLen = 700; %150kb? or less? depends on application // if GUI, user selects this
...
import Core.single_bargroup;
 [barMat,bars] = single_bargroup(xId,pthresh,PCC_OVERLAP,PCC_MP,len1,len2,lenOverlap,...
