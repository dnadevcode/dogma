...
% 
% 
% arrayfun(@(x) ~isempty(strfind(FileList(x).name,tiffname)),1:length(FileList))

files = dir('C:\Users\Lenovo\postdoc\DATA\Chromosome\Yeast_Luis_processed\220201\tif\*.tif');
dbmOSW.DBMSettingsstruct.outputDirpath = 'C:\Users\Lenovo\postdoc\DATA\Chromosome\Yeast_Luis_processed\220201\kymos\';
...
dbmOSW.DBMSettingsstruct.outputDirpath = 'C:\Users\Lenovo\postdoc\DATA\Chromosome\ECOLIMOV\lambdakymos\';
...
data = dir('C:\Users\Lenovo\postdoc\DATA\Chromosome\Yeast_Luis_processed\220314\czi\*.czi');
% 
