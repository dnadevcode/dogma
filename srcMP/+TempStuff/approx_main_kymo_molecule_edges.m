...
%     if isequal(method,'Otsu')
    import TempStuff.get_default_edge_detection_settings; %OptMap.MoleculeDetection.EdgeDetection.get_default_edge_detection_settings;
...
%             mainKymoMoleculeMask = false(size(kymo));
        ...
        case 'Otsu'
            ...
            import TempStuff.basic_otsu_approx_main_kymo_molecule_edges;
